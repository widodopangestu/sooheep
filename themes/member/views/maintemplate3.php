 ...
 <div class="item-blank">
 	<div class="container" style="background:#fff;margin-top:50px;">
				<div class="row">
					...
					<div class="row">	
						<div class="col-sm-12">
							Please Verified activation user from your email click "Resend" button to resend activation code into you email address
						</div>
					</div>
					</div>
					</div>
					<div class="row">
						...
						<?php 
						echo CHtml::link('Resend',Yii::app()->createUrl('/new/resend'),array('class'=>'link-button'))
						?>
						</div>
					</div>
 	</div>
