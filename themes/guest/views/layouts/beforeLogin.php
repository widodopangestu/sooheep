		...
		<div class="row">
			<div class="col-md-4 ">
				<div class="navbar-header">
					    <button type="button" class="navbar-toggle menu-button navbar-brand logo" data-toggle="collapse" data-target="#myNavbar">
					        <span class="glyphicon glyphicon-user"></span>Login
					    </button>
      					
      					<a class="navbar-brand logo" href="#">
      						<img class="new-logo" src="<?php echo Yii::app()->theme->baseUrl."/images/logo4.png"?>">
      						Soheep
      					</a>
    			</div>
			</div>
			...
			<div class="col-md-8 no-padding">
			    ...
			    ?>
			    <div class="col-sm-5">
			    <?php echo $form->textField($formLog,'username',array('class'=>"col-sm-6 form-control ",'placeholder'=>'username or email'))?>
			   	<br>
			   	</div>
			    <div class="col-sm-5">
			    <?php echo $form->passwordField($formLog,'password',array('class'=>"col-sm-6 form-control ",'placeholder'=>'username or email'))?>
			    <br>
			    </div>
			    <div class="col-sm-2 no-padding text-center">
			    <?php echo CHtml::htmlButton('Sign Me In',array('type'=>'submit', 'class'=>'link-button btn btn-default btneff'))?>
			    </div>
			    <?php $this->endWidget(); ?>
				</nav>
			</div>
