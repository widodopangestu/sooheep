	...
	<?php  
		...
		Yii::app()->clientScript->registerScript('upload-feed',"
		 $('#Feeds_images').fileupload({
	        url: '".Yii::app()->createUrl('/group/interest/uploadimage/id/'.$group->id_interest)."',
	        dataType: 'json',
		...
		<div class="col-md-4 col-sm-5 col-xs-12 col-left col-md-offset-1">
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default panel-friends">
						...
						<ul class="friends">
							<?php $fren = $this->getFriendsGroup(9);
								if($fren != null){
									foreach ($fren as $f){
										$idF = $f->id_user;
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default panel-photos">
						...
						<div class="panel-body text-center">
						<ul class="photos">
							<?php $fotos = $this->getGroupFotos($group->id_interest,15);
							if($fotos != null){
			...
			<div class="col-md-12">
				<div class="panel panel-default panel-groups">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-users"></i>&nbsp;Communities</h3>
					</div>
					<div class="panel-body">
						...
						<li class="list-group-item">
							<div class="col-sm-12">
							<a href="<?php echo Yii::app()->createUrl("/group/interest/community/id/".$com->community_hash)?>">
								<span class="name"><?php echo $com->community_name?></span>
							</a>
							</div>
		...
		<div class="col-md-6 col-sm-7 col-xs-12 col-right">
			...
			<div class="well well-sm well-social-post">
				...
				$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
						...
						'action' => CController::createUrl('/group/interest/setFeed/id/'.$group->id_interest),
						//'htmlOptions' => array(
			...
			$this->widget('bootstrap.widgets.TbListView', array(
		            'dataProvider' =>  $feed->getAllGroupFeeds($group->id_interest),
