...
class MasterCountry extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('country_code, phonecode, country_name', 'required'),
			array('country_code, phonecode', 'length', 'max'=>3),
			array('country_name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('country_id, country_code, phonecode, country_name', 'safe', 'on'=>'search'),
		);
	}
