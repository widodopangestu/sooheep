...
class Notification extends CActiveRecord
{
    ...
    public function getDescription($type)
    {
        ...
        switch ($type) {
            ...
            case self::TYPE_ADD_FRIEND:
                $description = "{friend} Want to be your friend";
                break;
            case self::TYPE_ACCEPT_FRIEND:
                $description = "{friend} accept your friend request";
                break;
            case self::TYPE_MESSAGE:
                $description = "{friend} Send Message to you";
                break;
            case self::TYPE_SUGESTION:
                $description = "{friend} Suggestion You";
                break;
            case self::TYPE_HEAP_LEVEL:
                $description = "{friend} Increase Your heap level";
                break;
        }
        return $description;
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('word, type, id_user, referation_link', 'required'),
